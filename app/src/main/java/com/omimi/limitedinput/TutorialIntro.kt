...
class TutorialIntro : AppIntro() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        openNavGesture.description = "Do the shown gesture below, to open the Navigation Drawer (Left side menu) "
        //openNavGesture.imageDrawable = R.drawable
        ...
        openOptionsMenuGesture.description = "Do the shown gesture below, to open the Toolbar Options Menu as a Dialog"
        //openOptionsMenuGesture.imageDrawable = R.drawable
        ...
        openTab1BottomNav.description = "Do the shown gesture below, to switch to the first tab"
        //openTab1BottomNav.imageDrawable = R.drawable
        ...
        openTab2BottomNav.description = "Do the shown gesture below, to switch to the second tab"
        //openTab2BottomNav.imageDrawable = R.drawable
        ...
        openTab3BottomNav.description = "Do the shown gesture below, to switch to the third tab"
        //openTab3BottomNav.imageDrawable = R.drawable
        ...
        openTab4BottomNav.description = "Do the shown gesture below, to switch to the fourth tab"
        //openTab4BottomNav.imageDrawable = R.drawable
        ...
        openTab5BottomNav.description = "Do the shown gesture below, to switch to the fifth tab"
        //openTab5BottomNav.imageDrawable = R.drawable

        addSlide(AppIntroFragment.newInstance(openTab5BottomNav))

        //todo add all of the drawable images to the tutorial
